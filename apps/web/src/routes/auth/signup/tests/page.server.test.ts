...
import { createFakeAuthSupabaseClientV2 } from '$lib/tests/supabase-helpers';
...
describe('actions.signUp', () => {
	test('should throw a redirect when sign up is successful', async () => {
		...
		const fakeSupabaseClient = createFakeAuthSupabaseClientV2('signUp', fakeSupabaseResponse);
